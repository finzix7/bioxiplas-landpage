...
This project uses **Astro** together with **Payload CMS**. Products and blogs are fetched from the Payload API so new content appears without redeploy.
...
Blog data is retrieved using requests like:
